...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-资源表树形.png)
...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-示例资源表.png)

#### 根目录

可以看到其中共有7种不同的资源类（24好像是清单类型，暂时每找到相关文档信息），首先在16进制编辑器中观察其根目录

![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-根目录.png)
...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-第一层Entry.png)
...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-第二层目录.png)
...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-第三层目录.png)

可以知道其NumberOfIdEntries为1，表示该资源代码页只有一项

紧跟其后就是IMAGE_RESOURCE_DIRECTORY_ENTRY结构

![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-第三层Entry.png)
...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-资源data.png)
...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-复杂程序.png)

可以看到根目录下第一类资源是用Name标识的，其名字为"AFX_DIALOG_LAYOUT"，我们在16进制中观察其IMAGE_RESOURCE_DIRECTORY_ENTRY

![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-复杂entry.png)
...
![](https://cdn.jsdelivr.net/gh/colaxianyu/imgbed/img/2024-07-21-名字结构.png)
